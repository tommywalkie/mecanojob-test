...
export const AppointmentsPage = () => {
  ...
  const getStatusCounts = (appointments: AppointmentResponse[] | undefined) => {
    if (!appointments) return { pending: 0, confirmed: 0, canceled: 0, completed: 0 }
    ...
    return appointments.reduce(
      ...
      { pending: 0, confirmed: 0, canceled: 0, completed: 0 } as Record<string, number>,
    )
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md ${
              statusFilter === 'all' ? 'bg-indigo-100 text-indigo-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
            }`}
          >
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-6 text-center text-red-500">Error loading appointments. Please try again.</div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredAppointments.map((appointment) => (
                  <tr key={appointment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{formatDate(appointment.startDate)}</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">{appointment.inviteeEmail}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
