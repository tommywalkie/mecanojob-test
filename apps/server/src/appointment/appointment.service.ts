...
import { BookAppointmentDto, CreateAppointmentDto, UpdateAppointmentDto } from './dtos'
...
export class AppointmentService {
  ...
  async create(user: User, createAppointmentDto: CreateAppointmentDto): Promise<Appointment> {
  ...
  async bookAppointment(bookAppointmentDto: BookAppointmentDto): Promise<Appointment> {
